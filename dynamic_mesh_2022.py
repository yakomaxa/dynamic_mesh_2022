...
# Restorer: Koya Sakuma
'''
Dynamic Mesh

This script was tested on PyMOL 2.5.0 Open-Source but not in rigorous ways
...
class DynamicMesh(Callback):
    ...
    def update(self):
        ...
        # modification to use this script in newer pymol
        stored.xyz = (self.center)
        cmd.alter_state(0, self.center_name, "(x,y,z) = stored.xyz")
        # modification
